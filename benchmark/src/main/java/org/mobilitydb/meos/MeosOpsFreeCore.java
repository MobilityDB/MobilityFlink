 ...
 * Free functions from meos.h
 * Methods emitted: 715 (stateless=432 · bounded-state=124 · windowed=80 · io-meta=42 · cross-stream=37)
...
public final class MeosOpsFreeCore {
     ...
     * <p>Classification: arithmetic op on temporal number (per-instant)</p>
     */
     ...
     * <p>Classification: scalar comparison/hash</p>
     */
    public static int text_cmp(Pointer arg0, Pointer arg1, Pointer arg2) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
                "text_cmp requires libmeos — set -Dmobilityflink.meos.enabled=true");
        }
        return GeneratedFunctions.text_cmp(arg0, arg1, arg2);
    }
     ...
     * <p>Pure per-event; safe in any scalar position.</p>
     * <p>Classification: text concatenation (per-instant)</p>
     */
